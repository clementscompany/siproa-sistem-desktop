...
import TableProcessos from "../../components/tables/TableProcessos";
import FormProcessoDialog from "./FormProcesso";
  ...
  return (
    <div style={{ padding: 20 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <h2 style={{ color: "var(--primary)" }}>Gestão de Processos</h2>
